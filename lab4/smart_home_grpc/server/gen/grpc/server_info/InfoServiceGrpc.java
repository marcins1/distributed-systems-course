...
public final class InfoServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "server_info.InfoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<grpc.server_info.DevicesInfoRequest,
      grpc.server_info.DevicesInfoResponse> getGetInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetInfo",
      requestType = grpc.server_info.DevicesInfoRequest.class,
      responseType = grpc.server_info.DevicesInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.server_info.DevicesInfoRequest,
      grpc.server_info.DevicesInfoResponse> getGetInfoMethod() {
    io.grpc.MethodDescriptor<grpc.server_info.DevicesInfoRequest, grpc.server_info.DevicesInfoResponse> getGetInfoMethod;
    if ((getGetInfoMethod = InfoServiceGrpc.getGetInfoMethod) == null) {
      synchronized (InfoServiceGrpc.class) {
        if ((getGetInfoMethod = InfoServiceGrpc.getGetInfoMethod) == null) {
          InfoServiceGrpc.getGetInfoMethod = getGetInfoMethod =
              io.grpc.MethodDescriptor.<grpc.server_info.DevicesInfoRequest, grpc.server_info.DevicesInfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.server_info.DevicesInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.server_info.DevicesInfoResponse.getDefaultInstance()))
              .setSchemaDescriptor(new InfoServiceMethodDescriptorSupplier("GetInfo"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getInfo(grpc.server_info.DevicesInfoRequest request,
        io.grpc.stub.StreamObserver<grpc.server_info.DevicesInfoResponse> responseObserver) {
  ...
  public static final class InfoServiceStub
    ...
    /**
     */
    public void getInfo(grpc.server_info.DevicesInfoRequest request,
        io.grpc.stub.StreamObserver<grpc.server_info.DevicesInfoResponse> responseObserver) {
  ...
  public static final class InfoServiceBlockingStub
    ...
    /**
     */
    public grpc.server_info.DevicesInfoResponse getInfo(grpc.server_info.DevicesInfoRequest request) {
  ...
  public static final class InfoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.server_info.DevicesInfoResponse> getInfo(
        grpc.server_info.DevicesInfoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_INFO:
          serviceImpl.getInfo((grpc.server_info.DevicesInfoRequest) request,
              (io.grpc.stub.StreamObserver<grpc.server_info.DevicesInfoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc.server_info.DevicesInfoRequest,
              grpc.server_info.DevicesInfoResponse>(
  ...
  private static abstract class InfoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.server_info.InfoProto.getDescriptor();
    }
  ...
  private static final class InfoServiceMethodDescriptorSupplier
    ...
    InfoServiceMethodDescriptorSupplier(java.lang.String methodName) {
